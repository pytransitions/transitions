...
from ..core import Machine, StateIdentifier, CallbacksArg, StateConfig, EventData
...
class MarkupMachine(Machine):
    ...
    def _omit_auto_transitions(self, event: EventData) -> bool: ...
    def _is_auto_transition(self, event: EventData) -> bool: ...
    @classmethod
