...
class HierarchicalMachine(Machine):
    ...
    def __init__(self, model: Optional[ModelParameter]=...,
                 ...
                 model_attribute: str = ..., on_exception: CallbacksArg = ..., **kwargs: Any) -> None: ...
    ...
    def add_ordered_transitions(self, states: Optional[Sequence[NestedState]] = ..., trigger: str = ..., loop: bool = ...,  # type: ignore[override]
                                ...
                                prepare: CallbacksArg = ..., **kwargs: Any) -> None: ...
    ...
    def _add_enum_state(self, state: Enum, on_enter: CallbacksArg, on_exit: CallbacksArg, ignore_invalid_triggers: bool,
                        remap: Optional[Dict[str, str]], **kwargs: Any) -> None: ...
    ...
    @classmethod
    def _create_event(cls, *args: Any, **kwargs: Any) -> NestedEvent: ...
    @classmethod
    def _create_state(cls, *args: Any, **kwargs: Any) -> NestedState: ...
